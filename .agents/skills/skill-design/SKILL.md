...
- Use [skill.template.md](.agents/skills/skill-design/templates/skill.template.md) as the starting point only when no domain-specific template or skill exists for the skill you are writing.
