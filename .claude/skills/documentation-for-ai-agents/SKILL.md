...
description: How to document a library, CLI tool, or API so another AI agent can use
  it correctly
when_to_use: when you need to create or update documentation for a library, CLI, or
  API that will be consumed by AI agents
---
...
## MUST
- Write the documentation as a skill following [skill-design.skill](.claude/skills/documentation-for-ai-agents/skill-design.skill/skill-design.skill.md).
...
## SHOULD
- Use the [skill.template.md](.claude/skills/documentation-for-ai-agents/skill-design.skill/templates/skill.template.md) when no domain-specific template exists.
...
- [ ] The skill follows [skill-design.skill](.claude/skills/documentation-for-ai-agents/skill-design.skill/skill-design.skill.md).
